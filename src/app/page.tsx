...
/**
 * Silently cleans any stray ?code= param from the URL without navigating.
 * This handles the edge case where Supabase incorrectly returns to the
 * homepage instead of /auth/callback.
 */
function AuthCodeCleaner() {
  ...
  useEffect(() => {
    ...
    if (code) {
      // Replace state instead of navigating — code is removed instantly, no flash
      const cleanUrl = window.location.pathname;
      window.history.replaceState({}, '', cleanUrl);
      // Then redirect to the callback route to complete the auth
